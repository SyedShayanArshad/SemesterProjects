...
namespace Library_Management_System
{
    public partial class IssueBookReport : Form
    {
        ...
        private async void IssueBookReport_Load(object sender, EventArgs e)
        {
        ...
        private void cbBookTitle_SelectedIndexChanged(object sender, EventArgs e)
        {
            _selectedBook = cbBookTitle.SelectedItem?.ToString();
        }
        private void btnSelectRollNo_Click_1(object sender, EventArgs e)
        {
            LoadDGVData(null, _selectedRollNo);
        }

        private void btnBookTitle_Click_1(object sender, EventArgs e)
        {
